...
{
    /// <summary>
    /// Representa un vector de tres componentes de precision simple
    /// </summary>
    public struct Vector3f
    {
        ...
        /// <summary>
        /// Inicializa una nueva instancia de Vector3f
        /// </summary>
        ...
        /// Inicializa una nueva instancia de Vector3f
        /// </summary>
        /// <param name="array">Array de tres elementos que representan un vector</param>
        public Vector3f(float[] array)
        {
            if (array.Length != 3)
                throw new ArgumentOutOfRangeException("array", array.Length, "La dimension del array debe ser tres");
            this.x = array[0];
            this.y = array[1];
            this.z = array[2];
        }
        ...
        /// Vector Unitario X
        /// </summary>
        public static Vector3f UnitarioX
        {
        ...
        /// Vector Unitario Y
        /// </summary>
        public static Vector3f UnitarioY
        {
        ...
        /// Vector Unitario Z
        /// </summary>
        public static Vector3f UnitarioZ
        {
